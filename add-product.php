          ...
          <div class="col-md-6">
            <div class="creat_product_n">
              <div class="add-product">
                <div class="descrip">
                  <form id="add-product" action="includes/product/addproduct.php" onSubmit="return validateForm();" enctype="multipart/form-data">
                    <h1>Title:</h1>
...
<script type="text/javascript">
   ...
   function hidethis() {
	...
	var imgCount = 0;
        ...
        drp = jq("div#image-drp").dropzone({
        	maxFilesize:2,
        	addRemoveLinks:true, 
        	url: "includes/product/upload.php",
        	dictRemoveFile:"X",
     		acceptedFiles: 'image/*',
    		maxFiles:9,
        ...
        $("#add-product").on("submit",function(evt){
			...
			if($('#product_title').val().length < 10){
				alert("Title should have minimum 10 characters");
				return false;
			} else if (CKEDITOR.instances['description'].getData() == '' || CKEDITOR.instances['description'].getData().length < 10) {
				alert("Description should have minimum 10 characters");
				return false;
			} else if (imgCount < 1){
            ...
            $.post("includes/product/addproduct.php",
            $("#add-product").find("input,select").serialize()+"&description="+ encodeURIComponent(CKEDITOR.instances['description'].getData()),
            function(res){
