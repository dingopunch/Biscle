            ...
            <div class="col-md-6">
              <div class="mainbar" >
                <ul class="mainMenu" >
                  ...
                  <li class="current"><a href="wall"><i class="fa fa-pencil">&nbsp;</i>Wall</a> </li>
          ...
          <div class="col-md-6">
            <div class="mainupd1">
                ...
                <form class="post-box" id="postupdate" action="includes/post/addpost.php" method="post" enctype="multipart/form-data">
                  ...
                  <div id="image-include"  style="display:none;" class="image-include">
                    ...
                    <div id="filediv" class="load-new">
                      <input name="imgUrl[]" multiple="multiple" class="" type="file" id="file"/>
                  ...
                  <div class="post-btn">
                    <input class="attachimg addimg" type="file" multiple="multiple" name="imgUrl[]" value="" id="attach">
                    <label for="attach" class="post-icon"><i class="fa fa-picture-o"></i></label>
                    <a href="#" class="post">
                    <input  id="submitpost"  type="submit" name="" value="Post">
                    </a>
                    <div class="shareto">
                      <select name="access">
              ...
              <div class="section-post wrap22">
                ...
                $postinfo= mysqli_query($con,"SELECT * FROM post  where userId='$userId' order by id DESC");
								$makepagination= "SELECT * FROM post  where userId='$userId' order by id DESC"; //select pagination
        ...
        echo "</div>";
                ...
                <?php } ?>
                 <!--p navigation-->
								<?php if (isset($next)) { ?>
                <div class="nav">
                  <a href='my-wall.php?p=<?php echo $next?>'>Next</a>
                </div>
                <?php } ?>
              </div>
            </div>
