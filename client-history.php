...
{
$_SESSION['clientuser']=$_GET['username'];
}
  ...
  if(mysqli_num_rows($userinfo2)==0)
  {
            ...
            <div class="col-md-6">
              <div class="mainbar" >
                <ul class="mainMenu profile-tab" >
                  ...
                  <li class="current"><a  href="<?php echo $dir_path ?><?php echo $user; ?>/client-history"><i class="fa fa-clock-o">&nbsp;</i>History</a> </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="buyr1">
              ...
              <?php
                ...
                $userproduct= mysqli_query($con,"SELECT * FROM buyrequest where userId='$clientid' order by id DESC");
								
								$makepagination= "SELECT * FROM buyrequest where userId='$clientid' order by id DESC"; //select pagination
...
$iter=0;
                ...
                <!--p navigation-->
								<?php if (isset($next)) { ?>
                <div class="nav">
                  <a href='<?php echo $dir_path ?><?php echo $user ?>/client-history/<?php echo $next?>'>Next</a> 
                </div>
                <?php } ?>
