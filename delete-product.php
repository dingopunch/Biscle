        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-grid" style="padding:0;">
              <div id="delcoment" class="new_btn">
              ...
              <div class="product-grid">
               <?php
                ...
                <a onclick="if (confirm('Are you sure...?')) delitem('products',<?php echo $pid; ?>, <?php echo $userId; ?>); return false" href="javascript:void(0);">
                <div class="col-md-4 col-sm-6 sel_prd" id="postitme<?php echo $pid; ?>">
                  <div class="thumb"> 
                  <div class="imgsize">
                  <img id="prd_src_<?php echo $pid; ?>" src="assets/files/products/<?php echo $imgUrl2[0]; ?>" alt="<?php echo $title; ?>" title="<?php echo $title; ?>"  />
                  </div>
