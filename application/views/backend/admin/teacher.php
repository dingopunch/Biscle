<div class="row">
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#teacher_info" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('Teacher Details');?>
                    	</a>
            </li>
			<li>
            	<a href="#rooms" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('Course/Subject');?>
                    	</a>
           </li>
                        
           <li>
            	<a href="#hours" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo get_phrase('Teaching Plan');?>
                    	</a>
           </li>
           <li>
		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="teacher_info">
