<div class="row">
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#student_info" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('Student Details');?>
                    	</a>
            </li>
			<li>
		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="student_info">
