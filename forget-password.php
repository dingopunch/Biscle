            ...
            <div class="signup-page">
            	<div class="row">
                	...
                	<div class="col-md-6 col-sm-7 forgot_contain">
                      <div class="signup">
                                <div class="reg-form">
                                  <span class="forgotpassword">Forgot you passwrd? please enter e-mail</span><br />
                                  <span id="result"></span>
                                    <form action="javascript:void(0);" onsubmit="resetpass()" method="post" id="resetpassword">
                                        <input class="signin_input" type="email" name="email" placeholder="E-mail" required />
                                        
                                        <input  class="loginbtn" type="submit" name="" value="Enter" />
                                    </form>
                                </div>
                            </div>
                    </div>
                    <div class="col-md-6 col-sm-5 forgot_contain">
                        <div class="">
                            <div class="signup">
                                <div class="reg-form">
                                  <span class="dontworry">Don’t worry!</span>
                                  <p class="dontext">We will sent a link for you to reset the password</p>
                                </div>
                            </div>
                         </div>
                    </div>
...
function resetpass(){
    if($($('[name="email"]')[0]).val().length<=0){
        ...
        return false;
		 ...
		 $.ajax({
			 type: "POST",
			 url: "includes/register/resetpassword.php",
